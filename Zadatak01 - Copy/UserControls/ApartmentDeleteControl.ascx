            ...
            <div class="mb-3">
                <asp:Panel ID="pnlButtons" runat="server">
                    <div class="d-flex justify-content-center">
                        <asp:Button ID="btnNo" OnClick="btnNo_Click" class="btn btn-danger" Style="margin-top:2rem; margin-right:.5rem; width:20%" runat="server" Text="No" />
                        <asp:Button ID="btnYes" OnClick="btnYes_Click" class="btn btn-outline-primary" Style="margin-top:2rem; margin-left:.5rem; width:20%" runat="server" Text="Yes" />
                    </div> 
                </asp:Panel>
            </div>
        </div>
