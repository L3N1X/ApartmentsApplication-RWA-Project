                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="display: flex; justify-content: right">
                                    <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" class="btn btn-outline-primary" Style="width: 100%" CommandArgument="<%#Eval(nameof(RwaApartmaniDataLayer.Models.Apartment.Id)) %>" runat="server" CausesValidation="false">Select</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="mb-3">
                                <asp:Label ID="Label7" runat="server" Text="Distance from beach (km)"></asp:Label>
                    ...
                    <div class="container my-3" style="display: flex; justify-content: center; align-items: center">
