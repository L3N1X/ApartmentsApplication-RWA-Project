<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="Tags.aspx.cs" Inherits="Zadatak01.Tags" %>

<%@ Register Src="~/App_UserControls/CreateTagControl.ascx" TagPrefix="uc1" TagName="CreateTagControl" %>
<%@ Register Src="~/App_UserControls/TagDeleteControl.ascx" TagPrefix="uc1" TagName="TagDeleteControl" %>
